...
uses
  ...
  Vcl.StdCtrls, Vcl.ComCtrls, Vcl.Imaging.jpeg, System.Types, ComObj;
...
type
  TForm1 = class(TForm)
    ...
    Version: TLabel;
    Label2: TLabel;
    ImgTitleSide1: TImage;
    ImgTitleSide2: TImage;
    ImgTitle: TImage;
    Button2: TButton;
...
ImgBackground.Width:=Form1.Width;
ImgBackground.Height:=Form1.Height;
//Menu Lateral ajustado com o tamanho do form
ImgMenu.Height:=Form1.Height-129;
//Versão do Aplicativo
Version.Caption:='|  ['+VersaoExe+' ]';
//Imagens
ImgFooter.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))     +'Texturas\Footer.png');
ImgHeader.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))     +'Texturas\Header.png');
ImgBackground.Picture.LoadFromFile(ExtractFilePath(ParamStr(0)) +'Texturas\Background.png');
ImgMenu.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))       +'Texturas\Menu.png');
ImgMaximizar.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))  +'Texturas\Max.png');
ImgFechar.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))     +'Texturas\Close.png');
ImgMinimizar.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))  +'Texturas\Min.png');
ImgTitleSide1.Picture.LoadFromFile(ExtractFilePath(ParamStr(0)) +'Texturas\TitleSide1.png');
ImgTitleSide2.Picture.LoadFromFile(ExtractFilePath(ParamStr(0)) +'Texturas\TitleSide2.png');
ImgTitle.Picture.LoadFromFile(ExtractFilePath(ParamStr(0))      +'Texturas\Title.png');
// Banco de Dados
end;
...
//=== Maximizar ================================================================
procedure TForm1.ImgMaximizarClick(Sender: TObject);
begin
